...
app.get('/', (req, res) => {
  res.render('index', { title: 'Guerreros Z App' });
});
...
app.get('/dashboard', async (req, res) => {
  try {
    ...
    res.render('dashboard', { 
      title: 'Dashboard de Guerreros Z', 
      superheroes 
    });
  } catch (error) {
    console.error('Error al obtener Guerreros Z:', error);
...
app.get('/addSuperhero', (req, res) => {
  res.render('addSuperhero', { title: 'Agregar Guerrero Z' });
});
